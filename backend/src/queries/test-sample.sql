...
VALUES
  ('Window Cleaning', 'I need the best of the best, will pay extra in tips for a good job!', 1, 2, 45.45, 1, '99 Queen St, Toronto, ON', 123.9, 44.2, '2017-07-23', 'open');
...
WHERE Listings.listid = 1 AND uid = 2 AND uid != poster_uid AND Listing.status = 'open' AND (
  SELECT COUNT(*)
...
VALUES(1, 1, 2, 3, 'HORRIBLE CLEANING SERVICE I HATE YOU');

-- OUTPUT TABLE
-- review_id listid reviewer_uid reviewee_uid rating comment                               timestamp
-- 1         1      1            2            3      HORRIBLE CLEANING SERVICE I HATE YOU  06-19-2025    
